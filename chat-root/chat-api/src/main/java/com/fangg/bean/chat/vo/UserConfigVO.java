...
public class UserConfigVO implements Serializable {
	...
	private Boolean bindIpFlag;			// 绑定IP标识
	private Boolean bindBrowerFlag;		// 绑定浏览器标识
	private String blackCode;			// 黑名单用户
	private String blackList;			// 黑名单用户列表
	private Integer blackType;				// 0解除黑名单，1加入黑名单
	...
	public Boolean getBindIpFlag() {
		return bindIpFlag;
	}

	public void setBindIpFlag(Boolean bindIpFlag) {
		this.bindIpFlag = bindIpFlag;
	}

	public Boolean getBindBrowerFlag() {
		return bindBrowerFlag;
	}

	public void setBindBrowerFlag(Boolean bindBrowerFlag) {
		this.bindBrowerFlag = bindBrowerFlag;
	}
